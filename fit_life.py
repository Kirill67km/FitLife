...
#Также прочитал про популрняую утилиту black для форматирования, ее применил для данного проекта
...
user_height = float(
    input(
        f"Принял, {user_name}! А теперь скажи какой у тебя рост " "(в метрах)?\n"
    ).replace(",", ".")
)
